...
{
    class TwitterUserMentionsEntities: TableEntity
    {
        public TwitterUserMentionsEntities(Guid guid, string screenName)
        {
            this.PartitionKey = screenName;
            this.RowKey = guid.ToString();
        }

        public TwitterUserMentionsEntities() { }
        ...
        public string TweetUserMentionsId { get; set; }
        public string TweetUserMentionsName{ get; set; }
